<template>
  <view
    class="uni-tag"
    v-if="text"
    :class="[disabled === true || disabled === 'true' ? 'uni-tag-disabled' : '',inverted === true || inverted === 'true' ? 'uni-tag-inverted' : '',circle === true || circle === 'true' ? 'uni-tag-circle' : '','uni-tag-'+size,'uni-tag-'+type]"
    @click="onClick()"
  >{{text}}</view>
</template>
