<template>
    ...
    <view class="" v-for="(address,index) in userAddressList" :key="index">
    	<user-address :address="address" :toPage="'/pages/user/addressUpdate?id=' + address.id " :current="userAddressCurrent.id" @choose="choose"></user-address>
    </view>
